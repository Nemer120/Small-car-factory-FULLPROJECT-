...
public class AddHybridMotorcycle extends JInternalFrame {
	...
	public AddHybridMotorcycle() {
		...
		JLabel lblNewLabel = new JLabel("PK");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(textField.getText().equals("")||textField_1.getText().equals("")||textField_2.getText().equals("")||textField_3.getText().equals("")||comboBox.getSelectedItem().equals("")||textField_4.getText().equals("")||textField_5.getText().equals(""))
					...
					if(model.Main.libr.getAllVehicleTransportation().containsKey("m"+textField.getText())) {
						JOptionPane.showMessageDialog(btnNewButton, "License plate already exist");
					}
					else {
						HybridMotorcycle h1= new HybridMotorcycle(Double.parseDouble(textField.getText()),Double.parseDouble(textField_1.getText()),(Color)comboBox.getSelectedItem(),Integer.parseInt(textField_2.getText()),Double.parseDouble(textField_3.getText()),Integer.parseInt(textField_4.getText()),rdbtnNewRadioButton.isSelected());
