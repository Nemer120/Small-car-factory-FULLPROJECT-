...
public class AddVan extends JInternalFrame {
	...
	public AddVan() {
		...
		JLabel lblNewLabel = new JLabel("License Plate");
		...
		lblNewLabel_6.setBounds(0, 161, 103, 14);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(textField.getText().equals("")||textField_1.getText().equals("")||textField_2.getText().equals("")||textField_3.getText().equals("")||comboBox.getSelectedItem().equals("")||textField_4.getText().equals("")||textField_5.getText().equals(""))
					...
					if(model.Main.libr.getAllVehicleTransportation().containsKey("V"+textField.getText())) {
						JOptionPane.showMessageDialog(btnNewButton, "Van's License plate already exist");
					}
					else {
						Van h1= new Van(Double.parseDouble(textField.getText()),Double.parseDouble(textField_1.getText()),(Color)comboBox.getSelectedItem(),Integer.parseInt(textField_2.getText()),Double.parseDouble(textField_3.getText()),Integer.parseInt(textField_4.getText()),Integer.parseInt(textField_5.getText()),Double.parseDouble(textField_3.getText()));
