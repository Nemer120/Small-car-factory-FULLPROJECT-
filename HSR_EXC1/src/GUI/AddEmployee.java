		...
		public void actionPerformed(ActionEvent e) {
			if(textField.getText().equals("")||textField_1.getText().equals("")||textField_2.getText().equals("")||textField_3.getText().equals("")||String.copyValueOf( passwordField.getPassword()).equals("")||comboBox.getSelectedItem().equals("") )
				...
				if(model.Main.libr.getAllEmployees().containsKey(textField.getText())) {
					...
					Employee h1= new Employee(textField.getText(),textField_1.getText(), textField_2.getText(),textField_3.getText(),(Gender)comboBox.getSelectedItem(),LocalDateTime.now(),Double.parseDouble(textField_6.getText()),(Department)comboBox_2.getSelectedItem(),Integer.parseInt(textField_4.getText()),String.copyValueOf( passwordField.getPassword()));
