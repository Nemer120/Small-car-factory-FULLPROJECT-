...
public class AddHybridCar extends JInternalFrame {
	...
	public AddHybridCar() {
		...
		lblNewLabel_5.setBounds(17, 136, 81, 14);
		contentPane.add(lblNewLabel_5);
		
		JLabel lblNewLabel_6 = new JLabel("Is Convertible");
		lblNewLabel_6.setBounds(17, 161, 74, 14);
		...
		rdbtnNewRadioButton.setBounds(133, 157, 54, 23);
